...
if(is_file(dirname(__FILE__).'/style.css')) {
    $css_url = $board_skin_url.'/style.css';
    add_stylesheet("<link rel='stylesheet' href='{$css_url}'>", 11);
}
            ...
            <form name="fwrite" id="fwrite" action="<?php echo $action_url ?>" onsubmit="return fwrite_submit(this);" method="post" enctype="multipart/form-data" autocomplete="off" style="width:<?php echo $width; ?>">
                ...
                <div class="write-wrap">
                    ...
                    <div class="form-group row">
                        <label for="wr_name" class="col-sm-12 col-md-2 col-form-label">성함</label>
                        ...
                        <label for="wr_email" class="col-sm-12 col-md-2 col-form-label">이메일</label>
                        <div class="col-sm-12 col-md-4">
                    ...
                    <div class="form-group row">
                        <label for="wr_1" class="col-sm-12 col-md-2 col-form-label">부서</label>
                        <div class="col-sm-12 col-md-4">
                            <input type="text" name="wr_1" value="<?php echo $wr_1 ?>" id="wr_1" required class="form-control" size="10" maxlength="20">
                        </div>
                        <label for="wr_2" class="col-sm-12 col-md-2 col-form-label">직책</label>
                        <div class="col-sm-12 col-md-4">
                    ...
                    <?php if ($is_category) { ?>
                        <div class="form-group row">
                            <label for="ca_name" class="col-sm-12 col-md-2 col-form-label">
                                문의종류<strong class="sr-only">필수</strong>
                            </label>
                            <div class="col-sm-12 col-md-4">
                    ...
                    <div class="form-group row">
                        <label for="wr_content" class="col-sm-12 col-md-2 col-form-label">
                            문의내용<strong class="sr-only">필수</strong>
                        </label>
                        <div class="col-sm-12 col-md-10 wr_content">
                            ...
                            <?php } ?>
                            <textarea id="wr_content" name="wr_content" class="" maxlength="65536" style="width:100%;height:300px"><?php echo $wr_content?></textarea>
                            <?php if ($write_min || $write_max) { ?>
                                <!-- 최소/최대 글자 수 사용 시 -->
